...
var Graphql_error = Caml_exceptions.create("PublishButton.PublishPost.Graphql_error");

var query = "mutation PublishMutation($id: ID!)  {\npublish(id: $id)  {\nid  \nisPublished  \n}\n}";

function parse(value) {
  var match = Js_json.decodeObject(value);
  if (match) {
    var value$1 = match[0]["publish"];
    ...
    if (match$1) {
      ...
      if (match$2) {
        ...
        var value$4 = value$2["isPublished"];
...
var PublishPostMutation = ReasonApollo.CreateMutation([
      query,
      parse
    ]);
...
function make$1(id, _) {
  ...
  newrecord[/* render */9] = (function () {
      var publishPostMutation = make(id, /* () */0);
      return ReasonReact.element(/* None */0, /* None */0, Curry._4(PublishPostMutation[/* make */4], /* None */0, /* None */0, /* None */0, (function (mutation, _) {
                        return React.createElement("a", {
                                    className: "f6 dim br1 ba ph3 pv2 mb2 dib black pointer",
                                    onClick: (function () {
                                        Curry._3(mutation, /* Some */[publishPostMutation.variables], /* Some */[/* array */["getFeedQuery"]], /* () */0);
...
exports.PublishPostMutation = PublishPostMutation;
exports.component = component;
exports.make = make$1;
/* PublishPostMutation Not a pure module */
